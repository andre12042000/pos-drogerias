                ...
                <div class="col-sm-6">
                    <div class="input-group float-right">
                        ...
                        <button type="button" class="btn btn-outline-light float-right ml-2" data-toggle="modal"
                            data-target="#motivosModal">Nuevo motivo <i class="las la-plus-circle"></i></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ucwords($motivo->name) }}</td>


                        <td>@if($motivo->status == 'ACTIVE')
                        ...
                        <td class="text-center">
                            ...
                            <a @popper(Editar) class="btn btn-outline-success btn-sm" href="#" role="button"
                                ...
                                wire:click="sendData( {{ $motivo }} )"><i class="bi bi-pencil-square"></i></a>

                            <button @popper(Eliminar) class="btn btn-outline-danger btn-sm"
                                wire:click="destroy( {{ $motivo->id }} )"><i class="bi bi-trash3"></i></button>
                        </td>
                    </tr>
...
@include('modals.motivoanulacion.create')
<script>
