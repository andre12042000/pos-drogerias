    ...
    <div class="modal-content">
        ...
        <div class="modal-body ">
            <div>
                ...
                <button type="button" class="btn btn-outline-success float-right ml-2 mt-3"
                    wire:click="save">Generar Orden</button>
                <x-adminlte-button class="float-right mt-3" wire:click="cancel" theme="danger" label="Cancelar"
                    data-dismiss="modal" />
                    ...
                    <div class="card card-outline card-warning">
                        <div class="card-body float-right">
                            <div class="row ">
                                ...
                                <div class="col-4">
                                    <a class="btn btn-outline-success" onclick="handleGuardarTransaccion()"><strong>Generar orden</strong></a>
                                </div>
                                <div class="col-1 ">
                                    ...
                                    @forelse ($products as $product)
                                        <tr data-product='{{ json_encode($product) }}'>
                                            ...
                                            <td class="price-cell text-end" data-option="disponible_caja"
                                                style="cursor: pointer" onclick="handlePriceClicks(this)">
