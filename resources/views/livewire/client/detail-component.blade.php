        ...
        <ul class="mt-5">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <div id="selectedRowsDiv" style="display: none;" class="col-lg-12 mt-8">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <label class="form-control-label" for="metodo_pago"><strong>METODO DE PAGO</strong></label>
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <select class="form-select" aria-label="Default select example" id="select_tipo_pago">
                ...
                <tbody>
                    @foreach ($credits as $credit)
                        <tr data-id="{{ $credit->id }}" data-valor="{{ $credit->valor }}"
                            ...
                            <!-- ... Resto de las celdas ... -->
                            <td><input class="form-check-input" type="checkbox" data-id="{{ $credit->id }}"
                                    id="deudaId" {{ $credit->saldo == 0 ? 'disabled' : '' }}
                                    data-bs-toggle="{{ $credit->saldo == 0 ? 'tooltip' : '' }}"
                                    data-bs-placement="top"
                                    title="{{ $credit->saldo == 0 ? 'Esta deuda ya ha sido pagada' : '' }}"></td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnPagar.addEventListener('click', function() {
            ...
            if (errores.length > 0) {
                ...
                Livewire.emit('realizarPagoTotalEvent', selectedRowsData, valorPagado, metodoPagoSelect.value);
