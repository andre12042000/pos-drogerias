            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="input-group float-right">
                        ...
                        <input type="text" class="form-control" placeholder="Buscar método pago" aria-label="Username"
                        ...
                        <button type="button" class="btn btn-outline-light float-right ml-2" data-toggle="modal"
                            data-target="#MetodoPagoModal">Nuevo Método <i class="las la-plus-circle"></i></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ucwords($metodo->name) }}</td>


                        <td>@if($metodo->status == 'ACTIVE')
                        ...
                        <td class="text-center">
                            ...
                            <a @popper(Actualizar) class="btn btn-outline-success btn-sm" href="#" role="button"
                                data-toggle="modal" data-target="#MetodoPagoModal"
                                wire:click="sendData( {{ $metodo }} )"><i class="bi bi-pencil-square"></i></a>
...
@include('modals.metodospago.create')
<script>
