<div class="modal-dialog" theme="primary">
    <div class="modal-content">
        <div class="modal-header bg-primary">
            <h5 class="modal-title " id="staticBackdropLabel"> <strong>Gestión de categoría de gastos</strong> </h5>
        ...
        <div class="modal-body ">
            ...
            <div>
                ...
                <button type="button" class="btn bbtn-outline-success float-right ml-2"  wire:click="storeOrupdate">Guardar</button>
