...
<div class="modal-dialog modal-m" theme="primary">
    <div class="modal-content">
        <div class="modal-header bg-primary">
            <h5 class="modal-title " id="staticBackdropLabel"> <strong>Gestión De Pagos Compras</strong> </h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" wire:model.lazy="saldo_formateado" id="saldo" name="saldo"
                        class="form-control"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="number" wire:model="abonar" id="abonar" name="abonar"
                    class="form-control"
        ...
        <div class="form-group row">
                            <label class="col-sm-5 col-form-label text-end">Fecha Pago  <span
                class="fs-6 text-danger ml-2" data-bs-toggle="tooltip" data-bs-placement="top"
                title="Campo obligatorio">*</span></label>
                            <div class="col-sm-7">
                                <input type="date" wire:model.lazy="proximo_pago" class="form-control @if($proximo_pago == '') @else @error('proximo_pago') is-invalid @else is-valid @enderror @endif" id="exampleFormControlInput1">
                               @error('proximo_pago')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
