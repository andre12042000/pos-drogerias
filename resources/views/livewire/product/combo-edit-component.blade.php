                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                ...
                                <button class="btn btn-outline-success" type="button" data-toggle="modal"
                                    data-target="#productoscombomodal">Añadir producto <i
                            ...
                            <table class="table table-striped" id="tabProducts">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (isset($producto['id']))
                                                    ...
                                                    <div class="col-8 ">
                                                    <a title="Aumentar" class="text-success" style="cursor: pointer" wire:click="aumentarcantidad({{ $producto['id']}})"><i class="bi bi-caret-up-fill"></i></a>
                                                    </div>
                                                    <div class="col-4 float-end">
                                                    </div>
                                                    <div class="col-8 float-end">
                                                    <a title="Disminuir" class="text-danger" style="cursor: pointer" wire:click="disminuircantidad({{ $producto['id']}})"><i class="bi bi-caret-down-fill"></i></a>
                                                    </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8">
                                                <p>No hay productos añadidos para mostrar...</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                        ...
                        @if ($error_cantidad_productos)
                            <span class="text-danger text-center">Para crear un combo, se requieren al menos 2
                                productos!</span>
                        @enderror
