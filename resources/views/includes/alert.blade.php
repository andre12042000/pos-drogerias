...
@if (session()->has('venta_exitosa'))
    <div class="alert alert-success" role="alert">
        ...
        Venta registrada correctamente, <a href=" {{ route('ventas.pos.details', session('venta_exitosa')) }}"
            class="alert-link" target="_blank">Ver comprobante</a>.
        <a href="{{ route('ventas.pos.imprimir.recibo', session('venta_exitosa')) }}" class="alert-link float-end"
            target="_blank"> <i class="bi bi-printer"></i> Imprimir recibo</a>
    </div>
