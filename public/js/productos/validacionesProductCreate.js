...
function capturarYEnviarDatos() {
    ...
    var datos = {
        ...
        contenido_interno_caja: document.getElementById("contenido_interno_caja").value,
        contenido_interno_blister: document.getElementById("contenido_interno_blister").value,
        contenido_interno_unidad: document.getElementById("contenido_interno_unidad").value,
