...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'precio_caja'                => $this->faker->randomElement([1000, 2000, 30000, 400000]),
            'precio_blister'        => $this->faker->randomElement([900, 1800, 29000, 38000]),
            'precio_unidad'   => $this->faker->randomElement([800, 1500, 25000, 35000]),
