   ...
   public function confirmacionaplicar()
    ...
    public function seleccinarProducto($product)
    {
        ...
        if ($buscarproducto) {
            ...
            $this->precioventacliente = $buscarproducto->sell_price;
            $this->precioventatecnico = $buscarproducto->sell_price_tecnico;
            $this->precioventadistribuidor = $buscarproducto->sell_price_distribuidor;
